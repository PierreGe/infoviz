...
Additionally, many of the stations of the Brussels public transport network are only served by one line. This implies that any problem in a single point can have a big effect on the ability to travel in Brussels. In the other hand, some stations are served by a greater number of lines than the average, making them also strategic points in the public transportation network mobility, consequently, making them relevant points to consider if some disturbance occurs near of its area.
